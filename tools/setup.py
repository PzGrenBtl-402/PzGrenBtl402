...
def main():
  ...
  This script will create two hard links on your system, both pointing to your PzGrenBtl402 project folder:
    [Arma 3 installation directory]\\{} => PzGrenBtl402 project folder
    P:\\{}                              => PzGrenBtl402 project folder
...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the PzGrenBtl402 wiki to perform the setup manually.")
    else:
