...
class RscInGameUI {
    ...
    class PzGrenBtl402_RSC_Turret: Redd_RCS_Turret {
    ...
    class PzGrenBtl402_RSC_Milan: Redd_RSC_Milan {
        class CA_IGUI_elements_group: CA_IGUI_elements_group {
            class controls: controls {
                class CA_Heading: CA_Heading {
                    DISABLE_FEATURE;
    ...
    class PzGrenBtl402_RSC_Driver: Redd_RCS_Driver {
        class CA_IGUI_elements_group: CA_IGUI_elements_group {
            class controls: controls {
                class CA_TurretIndicator: CA_TurretIndicator {
                    DISABLE_FEATURE;
    ...
    class PzGrenBtl402_RSC_MG3: Redd_RSC_MG3 {
        class CA_IGUI_elements_group: CA_IGUI_elements_group {
            class controls: controls {
                class CA_Heading: CA_Heading {
                    DISABLE_FEATURE;
