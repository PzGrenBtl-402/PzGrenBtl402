class CfgVehicles {
    ...
    // CUP_Ind_Workshop01
    class House;
    SET_ARMOR(House,Land_Ind_Workshop01_01);
    SET_ARMOR(House,Land_Ind_Workshop01_02);
    SET_ARMOR(House,Land_Ind_Workshop01_03);
    SET_ARMOR(House,Land_Ind_Workshop01_04);
    SET_ARMOR(House,Land_Ind_Workshop01_box);
    SET_ARMOR(House,Land_Ind_Workshop01_L);
    ...
    SET_ARMOR(House,Land_Sara_zluty_statek_in);
    ...
    SET_ARMOR(House,Land_Dum_olez_istan2_maly);
    ...
    SET_ARMOR(House,Land_HouseB_Tenement);
    ...
    SET_ARMOR(House,Land_a_stationhouse);
    ...
    SET_ARMOR(House,Land_A_GeneralStore_01);

    // CUP_CAStructuresHouse_A_Office01
    SET_ARMOR(House,Land_A_Office01);

    // CUP_CAStructuresHouse_A_Office02
    SET_ARMOR(House,Land_A_Office02);

    // CUP_CABuildings2_A_Pub
    SET_ARMOR(House,Land_A_Pub_01);
    ...
    SET_ARMOR(House_EP1,Land_A_Stationhouse_ep1);

    // CUP_CAStructures_E_HouseC
    SET_ARMOR(House_EP1,Land_House_C_10_EP1);
    SET_ARMOR(House_EP1,Land_House_C_11_EP1);
    SET_ARMOR(House_EP1,Land_House_C_12_EP1);
    SET_ARMOR(House_EP1,Land_House_C_1_EP1);
    SET_ARMOR(House_EP1,Land_House_C_1_v2_EP1);
    SET_ARMOR(House_EP1,Land_House_C_2_EP1);
    SET_ARMOR(House_EP1,Land_House_C_3_EP1);
    SET_ARMOR(House_EP1,Land_House_C_4_EP1);
    SET_ARMOR(House_EP1,Land_House_C_5_EP1);
    SET_ARMOR(House_EP1,Land_House_C_5_V1_EP1);
    SET_ARMOR(House_EP1,Land_House_C_5_V2_EP1);
    SET_ARMOR(House_EP1,Land_House_C_5_V3_EP1);
    SET_ARMOR(House_EP1,Land_House_C_9_EP1);

    // CUP_CAStructures_E_HouseK
    SET_ARMOR(House_EP1,Land_House_K_2_basehide_EP1);
    SET_ARMOR(House_EP1,Land_House_K_3_EP1);
    SET_ARMOR(House_EP1,Land_House_K_5_EP1);
    SET_ARMOR(House_EP1,Land_House_K_6_EP1);
    SET_ARMOR(House_EP1,Land_House_K_7_EP1);
    SET_ARMOR(House_EP1,Land_House_K_8_EP1);
    ...
    SET_ARMOR(House_EP1,Land_House_L_6_EP1);
    SET_ARMOR(House_EP1,Land_House_L_7_EP1);
    SET_ARMOR(House_EP1,Land_House_L_8_EP1);
    SET_ARMOR(House_EP1,Land_House_L_9_EP1);

    // CUP_CAStructures_E_Mil
    SET_ARMOR(House_EP1,Land_Mil_Barracks_EP1);
    ...
    SET_ARMOR(House_EP1,Land_Mil_ControlTower_EP1);
    SET_ARMOR(House_EP1,Land_Mil_ControlTower_no_interior_EP1_CUP);
    SET_ARMOR(House_EP1,Land_Mil_Guardhouse_EP1);
    SET_ARMOR(House_EP1,Land_Mil_Guardhouse_no_interior_EP1_CUP);
    SET_ARMOR(House_EP1,Land_Mil_House_EP1);
    SET_ARMOR(House_EP1,Land_Mil_House_no_interior_EP1_CUP);
    SET_ARMOR(House_EP1,Land_Mil_Repair_center_EP1);
    SET_ARMOR(House_EP1,Land_Mil_hangar_EP1);
    ...
    SET_ARMOR(House_EP1,Land_A_Mosque_big_addon_EP1);
    SET_ARMOR(House_EP1,Land_A_Mosque_big_hq_EP1);
    ...
    SET_ARMOR(House_EP1,Land_A_Villa_EP1);
};
