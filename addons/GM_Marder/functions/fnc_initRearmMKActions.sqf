...
[
    ...
    _rearmHeIcon,
    _rearmHeIcon,
    "_this isEqualTo (fullCrew [_target, 'turret', true] select 2 select 0) && isNull gunner _target",
    "_caller isEqualTo (fullCrew [_target, 'turret', true] select 2 select 0) && isNull gunner _target",
    {},
    {},
    {
        params ["_veh"];
