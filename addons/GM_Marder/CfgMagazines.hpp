...
class CfgMagazines
{
  ...
  class PzGrenBtl402_400Rnd_20x139mm_hei_t_dm81: gm_425Rnd_20x139mm_hei_t_dm81
  {
  ...
  class PzGrenBtl402_100Rnd_20x139mm_apds_t_dm63: gm_75Rnd_20x139mm_apds_t_dm63
  {
    author = ECSTRING(Main, authors);
    count = 100;
