...
class CfgSoundEffects
{
    class AttenuationsEffects
    {
        ...
        class TankAttenuation_402_Marder: TankAttenuation
        {
            acreAttenuation = 1;
        };
    };
...
class CfgVehicles
{
    ...
    class Redd_Marder_1A5_base: Tank_F
    {
        ...
        attenuationEffectType = "TankAttenuation_402_Marder";
        ...
        {
            fired = "_this call PzGrenBtl402_fnc_marderFired; _this call redd_fnc_Marder_Fired"; //Patrone an der Waffe verstecken und Magazin entfernen, gleichzeitig RnT Funktion weiterhin aufrufen
