...
[
    ...
    {
        params ["_vehicle"];
        [_vehicle, [0], "Redd_SmokeLauncherMag", [QEGVAR(Rearm,smoke_3grenade_ammo)], 3 * EGVAR(Rearm,rearmSmokeDuration)] call EFUNC(Rearm,rearm);
    },
    {},
    [],
    HOLD_TIME,
...
[
    ...
    {},
    {
        ...
        [_vehicle, [0], "Redd_Mg3_Mag", _mg3CompatibleMags, EGVAR(Rearm,rearmMGDuration)] call EFUNC(Rearm,rearm);
    },
    {},
    [_mg3CompatibleMags],
    HOLD_TIME,
