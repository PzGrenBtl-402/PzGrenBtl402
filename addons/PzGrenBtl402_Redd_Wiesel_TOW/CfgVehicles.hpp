class CfgSoundEffects
{
	class AttenuationsEffects
	{
		...
		class TankAttenuation_402_Wiesel_TOW: TankAttenuation
		{
			acreAttenuation = 1;
		};
	};
...
class CfgVehicles
{
	...
	class Redd_Tank_Wiesel_1A2_TOW_base: Tank_F
	{
		...
		attenuationEffectType = "TankAttenuation_402_Wiesel_TOW";
		...
		{
			fired = "_this call PzGrenBtl402_fnc_WieselTOWFired";
		};
